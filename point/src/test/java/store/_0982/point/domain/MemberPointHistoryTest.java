...
class MemberPointHistoryTest {
    ...
    void createUsedHistory() {
        ...
        assertThat(history.getStatus()).isEqualTo(MemberPointHistoryStatus.USED);
    ...
    void createReturnedHistory() {
        ...
        assertThat(history.getStatus()).isEqualTo(MemberPointHistoryStatus.RETURNED);
        assertThat(history.getIdempotencyKey()).isEqualTo(idempotencyKey);
    }
    ...
    void differentStatus() {
        ...
        // when
        MemberPointHistory usedHistory = MemberPointHistory.used(memberId, deductCommand);
        MemberPointHistory returnedHistory = MemberPointHistory.returned(memberId, returnCommand);

        // then
        assertThat(usedHistory.getStatus()).isEqualTo(MemberPointHistoryStatus.USED);
        assertThat(returnedHistory.getStatus()).isEqualTo(MemberPointHistoryStatus.RETURNED);
