...
import store._0982.point.point.application.dto.PointRefundInfo;
import store._0982.point.point.presentation.dto.*;
...
public class PaymentPointController {
    ...
    @ResponseStatus(HttpStatus.OK)
    @PostMapping("/refund")
    public ResponseDto<PointRefundInfo> pointRefund(@RequestHeader("X-Member-Id") UUID memberId,@RequestBody PointRefundRequest request){
        PointRefundInfo info = paymentPointService.pointRefund(memberId, request.toCommand());
