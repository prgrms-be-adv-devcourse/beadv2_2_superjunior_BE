...
public class MemberController {
    ...
    public ResponseDto<PageResponse<AddressInfo>> getAddresses(@RequestHeader(value = "X-Member-Id", required = true) UUID memberId, org.springframework.data.domain.Pageable pageable) {
