...
public class MemberController { //todo log 달기
    ...
    @DeleteMapping
    public ResponseDto<Object> deleteMember(@RequestHeader(value = "X-Member-Id", required = false) UUID memberId , @RequestBody MemberDeleteRequest request){
    ...
    public ResponseDto<Object> checkHeader(
