...
public class MemberController { //todo log 달기
    ...
    public ResponseDto<Void> changePassword(
            @RequestHeader(value = "X-Member-Id", required = true) UUID memberId,
    ...
    public ResponseDto<ProfileUpdateInfo> updateProfile(
            @RequestHeader(value = "X-Member-Id", required = true) UUID memberId, @Valid @RequestBody ProfileUpdateRequest request) {
