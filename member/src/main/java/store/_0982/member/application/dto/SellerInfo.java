...
public record SellerInfo(UUID sellerId, String email, String name, OffsetDateTime createdAt, String imageUrl,
                         ...
                         String businessRegistrationNumber, int settlementBalance) {

    public static SellerInfo from(Seller seller) {
        Member member = seller.getMember();
        return new SellerInfo(seller.getSellerId(), member.getEmail(), member.getName(), seller.getCreatedAt(), member.getImageUrl(), member.getPhoneNumber(), seller.getAccountNumber(), seller.getBankCode(), seller.getAccountHolder(), seller.getBusinessRegistrationNumber(), seller.getSettlementBalance());
    }
    ...
    public SellerInfo blind() {
        return new SellerInfo(this.sellerId(), this.email(), this.name(), this.createdAt(), this.imageUrl(), null,  // phoneNumber
                ...
                null,  // bankCode
                null,  // accountHolder
                this.businessRegistrationNumber(), 0   // settlementBalance
        );
