...
public final class ProductTextProvider {
    ...
    private static final String[] HOME_NOUN = {
            "수납박스", "도마 세트", "머그컵 세트", "주방행주", "청소 브러시", "수납 바구니", "생활용품 세트",
            "식기 건조대", "욕실 슬리퍼", "다용도 선반"
    };
    ...
    private static final String[] FOOD_NOUN = {
            "사과주스", "견과 세트", "그래놀라", "잡곡밥", "블루베리", "그릭요거트", "닭가슴살", "수제 쿠키",
            "한우 등심 500g", "방울토마토"
    };
    ...
    private static final String[] HEALTH_NOUN = {
            "비타민C 1000", "오메가3 캡슐", "프로바이오틱스", "루테인 복합", "콜라겐", "멀티비타민",
            "체중계", "마사지건", "손목 보호대", "홈트 밴드"
    };
    ...
    private static final String[] BEAUTY_NOUN = {
            "크림", "선크림", "클렌징폼", "헤어 에센스", "립 틴트", "아이크림", "앰플", "마스크팩",
            "미스트", "핸드크림"
    };
    ...
    private static final String[] FASHION_NOUN = {
            "자켓", "라운드 티", "코트", "슬랙스", "가디건", "머플러", "스니커즈", "셔츠", "후드",
            "에코 레더 백"
    };

    private static final String[] ELECTRONICS_ADJ = {
            "무선", "블루투스", "고성능", "초경량", "게이밍", "멀티포트", "고속 충전", "저전력",
            "스마트", "휴대용"
    };
    private static final String[] ELECTRONICS_NOUN = {
            "이어폰", "스피커", "USB-C 허브", "마우스", "키보드", "보조배터리", "스마트 워치",
            "모니터 암", "웹캠", "노트북 스탠드"
    };

    private static final String[] KIDS_ADJ = {
            "안전한", "부드러운", "유아용", "키즈", "알록달록", "내구성 좋은", "저자극", "교육용",
            "가벼운", "실용적인"
    };
    private static final String[] KIDS_NOUN = {
            "원목 블록", "그림책", "식기 세트", "수면등", "물티슈", "내의", "레인부츠", "유아 의자",
            "스티커북", "장난감 정리함"
    };

    private static final String[] HOBBY_ADJ = {
            "입문용", "전문가용", "빈티지", "아날로그", "디지털", "디테일한", "휴대용", "DIY", "프리미엄", "스탠다드"
    };
    private static final String[] HOBBY_NOUN = {
            "미니어처 키트", "수채화 물감", "캘리그래피 펜", "드로잉 패드", "보드게임", "퍼즐",
            "가죽 공예 키트", "모형 키트", "캠핑 랜턴", "드론"
    };

    private static final String[] PET_ADJ = {
            "저알러지", "영양 듬뿍", "프리미엄", "무향", "부드러운", "튼튼한", "안전한", "편안한", "대형", "미니"
    };
    private static final String[] PET_NOUN = {
            "강아지 간식", "고양이 모래 10L", "반려동물 샴푸", "자동 급식기", "캣타워", "이동가방",
            "털 제거 브러시", "하네스", "장난감", "급수기"
    };

    private static final String[] HOME_DESC_PREFIX = {
            "집안에서 유용한 생활 아이템입니다.", "공간 활용을 높여주는 제품입니다.", "관리와 보관이 편리하도록 설계했습니다."
    };
    private static final String[] HOME_DESC_SUFFIX = {
            "깔끔한 정리와 위생 관리에 도움이 됩니다.", "실사용 중심의 구성으로 준비했습니다.", "일상에서 자주 쓰는 품목입니다."
    };

    private static final String[] FOOD_DESC_PREFIX = {
            "신선한 재료로 정성껏 만든 식품입니다.", "간편하게 즐길 수 있는 먹거리입니다.", "맛과 품질을 함께 담았습니다."
    };
    private static final String[] FOOD_DESC_SUFFIX = {
            "가볍게 한 끼로도 좋습니다.", "냉장/냉동 보관이 용이합니다.", "가족과 함께 즐기기 좋습니다."
    };

    private static final String[] HEALTH_DESC_PREFIX = {
            "일상 속 건강 관리를 돕는 제품입니다.", "활력 있는 하루를 위한 아이템입니다.", "꾸준한 섭취에 적합합니다."
    };
    private static final String[] HEALTH_DESC_SUFFIX = {
            "필요한 영양을 챙길 수 있습니다.", "운동과 함께 사용하기 좋습니다.", "부담 없이 시작할 수 있습니다."
    };

    private static final String[] BEAUTY_DESC_PREFIX = {
            "피부 결을 매끄럽게 정돈해주는 제품입니다.", "데일리 케어에 적합한 포뮬러입니다.", "가볍게 사용할 수 있습니다."
    };
    private static final String[] BEAUTY_DESC_SUFFIX = {
            "산뜻한 마무리감을 제공합니다.", "피부 타입에 부담이 적습니다.", "보습과 진정에 도움을 줍니다."
    };

    private static final String[] FASHION_DESC_PREFIX = {
            "데일리 룩에 자연스럽게 어울립니다.", "편안한 착용감을 강조했습니다.", "다양한 스타일링이 가능합니다."
    };
    private static final String[] FASHION_DESC_SUFFIX = {
            "계절감 있게 활용할 수 있습니다.", "기본 아이템으로 추천드립니다.", "활동성을 고려했습니다."
    };

    private static final String[] ELECTRONICS_DESC_PREFIX = {
            "실용적인 기능과 성능을 갖춘 제품입니다.", "사용 편의성을 높여 설계했습니다.", "일상과 업무에 유용합니다."
    };
    private static final String[] ELECTRONICS_DESC_SUFFIX = {
            "안정적인 사용감을 제공합니다.", "휴대성이 좋습니다.", "연결성과 호환성을 고려했습니다."
    };

    private static final String[] KIDS_DESC_PREFIX = {
            "아이들의 안전을 고려한 제품입니다.", "부드러운 소재로 제작했습니다.", "성장 단계에 맞춰 쓸 수 있습니다."
    };
    private static final String[] KIDS_DESC_SUFFIX = {
            "사용이 간편하고 관리가 쉽습니다.", "아이들의 흥미를 높입니다.", "일상에서 활용도가 높습니다."
    };

    private static final String[] HOBBY_DESC_PREFIX = {
            "취미 시간을 더 즐겁게 만들어 줍니다.", "초보자도 쉽게 시작할 수 있습니다.", "완성도를 높여줍니다."
    };
    private static final String[] HOBBY_DESC_SUFFIX = {
            "집중력을 높이는 데 도움이 됩니다.", "선물용으로도 좋습니다.", "디테일을 살렸습니다."
    };

    private static final String[] PET_DESC_PREFIX = {
            "반려동물의 건강과 행복을 고려했습니다.", "편안한 사용감을 제공하는 제품입니다.", "반려동물 케어에 유용합니다."
    };
    private static final String[] PET_DESC_SUFFIX = {
            "관리와 사용이 간편합니다.", "안전하게 사용할 수 있습니다.", "일상 케어에 잘 어울립니다."
    };
}
