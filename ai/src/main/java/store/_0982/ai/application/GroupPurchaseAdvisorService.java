...
import store._0982.ai.application.dto.AdvisorVectorSearchRequest;
import store._0982.ai.application.dto.VectorSearchResponse;
import store._0982.ai.infrastructure.feign.commerce.CommerceFeignClient;
import store._0982.ai.infrastructure.feign.commerce.dto.GroupPurchasePerformanceInfo;
import store._0982.ai.infrastructure.feign.commerce.dto.ProductDetailInfo;
...
public class GroupPurchaseAdvisorService {
    ...
    private final AdvisorPromptService advisorPromptService;
